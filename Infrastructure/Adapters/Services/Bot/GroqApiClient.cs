    ...
    GroqAuthHeaderProvider authHeaderProvider) : IGroqApiClient
{
    ...
    internal static string BuildSystemPrompt()
    {
        ...
        13. SUBTAREAS: si el usuario pide una tarea que dependa de otra (""una subtarea dentro de la #412"", ""una tarea hija de Levantamiento de datos"", ""y otra debajo de esa""), NO existe una acción aparte: es ""create_task"" con ""parentId"" (el número de la tarea padre) o, si la nombró por asunto, ""parentName"". Aquí SÍ va un número: es la excepción a la regla 2, porque el usuario nombra a la tarea padre por su ID. Si esa tarea ya se listó o se creó antes en esta conversación, toma ese ID del historial en vez de preguntarlo. Con tarea padre NO hace falta ""projectName"": la subtarea se crea en el proyecto de la padre. Si OpenProject rechaza la jerarquía, muéstrale al usuario el motivo que devuelve el sistema, sin reformularlo como un error genérico.

        14. IDIOMA: responde siempre en español latinoamericano neutro. Usa ""tú"" (""puedes"", ""dime"", ""verifica""), nunca ""vos"" ni formas como ""tenés"", ""fijate"", ""dale"". Sin modismos regionales.
